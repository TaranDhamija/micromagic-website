...
const trustItems = [
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
        ...
        />
        <path
          d="M20 8 L28 12 L28 22 C28 27 24 31 20 32 C16 31 12 27 12 22 L12 12 Z"
          fill="none"
          stroke="#4e7c5f"
          strokeWidth="1.5"
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
        ...
        />
        <path
          d="M16 14 L16 11 C16 9.3 17.3 8 19 8 L21 8 C22.7 8 24 9.3 24 11 L24 14"
          stroke="#4e7c5f"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
        ...
        />
        <path
          d="M12 20 C12 15.6 15.6 12 20 12 L20 20 L26 24"
          stroke="#4e7c5f"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8">
        ...
        />
        <path
          d="M14 26 C14 22 17 19 20 19 C23 19 26 22 26 26"
          stroke="#4e7c5f"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
...
const certBadges = [
  ...
  },
  {
    ...
    sub: 'Clean Label Verified',
  },
  {
    label: 'Small Batch',
    sub: 'Fresh Production',
  },
  {
    label: '100% Traceable',
    sub: 'Source Transparent',
  },
];
...
export default function TrustSection() {
  ...
  return (
    <section
      ref={ref}
      className="py-24 px-6 bg-parchment relative overflow-hidden"
    >
      {/* Background accent */}
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="text-center mb-16">
          <p className="section-label reveal justify-center before:hidden">
            Trust & Quality
          </p>
          ...
          <h2 className="text-4xl md:text-5xl text-forest reveal reveal-delay-1 mb-4">
            Why people trust
            <br />
            <em className="font-serif text-sage italic">
              MicroMagic
            </em>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
          {trustItems.map((item, i) => (
            ...
            >
              ...
              <h3 className="font-sans text-sm font-semibold text-forest mb-2 leading-snug">
                {item.title}
              </h3>
