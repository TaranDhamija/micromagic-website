...
export default function Products() {
    ...
    <div>
      ...
      <div className="bg-forest pt-32 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <p className="section-label text-goldlight before:bg-goldlight mb-5">
            Collection
          </p>
  ...
  gallery of quiet visual moments.
            ...
            <div className="rounded-[32px] border border-cream/10 bg-cream/5 p-7 backdrop-blur-md">
              <p className="text-[10px] uppercase tracking-[2.6px] text-goldlight/75 mb-3">
                Product Discovery
              </p>
      ...
      <div className="bg-gold/15 border-b border-gold/20 px-6 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2.5 text-sm text-forest">
            ...
            <strong>Fresh small batch</strong> — every product is packed in
            limited runs for better freshness
          </div>

          <a
            href={waLink(
              'Hi MicroMagic! What products are currently in stock?'
            )}
            target="_blank"
            ...
            <div className="max-w-2xl">
              ...
              <h2 className="text-[clamp(34px,4.6vw,58px)] text-forest reveal reveal-delay-1 mb-4">
                ...
                <em className="italic text-sage">
                  each with its own visual story.
                </em>
              </h2>
            </div>

            <p className="max-w-xl font-display text-[21px] leading-relaxed text-textlight reveal reveal-delay-2">
              Every card below supports a multi-image gallery from the start,
              so the experience can grow naturally when final product
      ...
      <section className="py-16 px-6 bg-parchment border-y border-forest/8">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="font-display text-xl text-textlight mb-7 leading-relaxed">
            Share your routine, your goals, or what feels off right now.
            We&apos;ll help you choose the most natural starting point without
            upselling.
          </p>

          <a
            href={waLink(
              "Hi MicroMagic! I'm not sure which product is best for my situation. Can you help me choose?"
            )}
            target="_blank"
            rel="noopener noreferrer"
      ...
      <section className="py-24 px-6 bg-forest relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-14">
            <p className="section-label justify-center before:bg-goldlight text-goldlight">
              Bundle Offers
            </p>

            <h2 className="font-serif text-4xl text-cream mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            {combos.map((combo, i) => (
              <div
                key={combo.id}
                className={`relative rounded-[28px] p-10 hover:-translate-y-2 hover:shadow-[0_24px_80px_rgba(0,0,0,0.28)] transition-all duration-400 reveal reveal-delay-${
                  i + 1
                } ${
                  combo.featured
              ...
              >
                ...
                <p
                  className={`text-[11px] font-medium tracking-[2.5px] uppercase mb-2 ${
                    combo.featured
                      ? 'text-forest/60'
                      : 'text-mint'
                  }`}
                  ...
                  <span
                    className={`text-xs font-medium px-3 py-1 rounded-full mb-1 ${
                      combo.featured
                        ...
                        : 'bg-goldlight/15 text-goldlight'
                    }`}
                  >
                    {combo.savings}
                  </span>
                ...
                <a
                  ...
                  className={`flex items-center justify-center gap-2.5 w-full py-3.5 rounded-full text-sm font-medium transition-all duration-300 ${
                    combo.featured
                      ? 'bg-forest text-goldlight hover:bg-moss'
